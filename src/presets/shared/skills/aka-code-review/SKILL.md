...
| **Security review** | Auth changes, user input, APIs, secrets, pre-PR security audit | `references/security-review.md` |
...
├─ Security-sensitive change (auth/input/API/secrets) → Load security-review.md checklist
